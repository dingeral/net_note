...
- [TrafficMonitor](https://github.com/zhongyang219/TrafficMonitor)：显示网速和CPU利用率

- [Office 365](https://github.com/KusakabeSi/free365)

- [Geek](https://geekuninstaller.com/)：卸载程序

- [Quicker](https://getquicker.net/)

- [Potplayer](https://potplayer.daum.net/)：不错的播放器。

- [Ninite](https://ninite.com/)：软件包管理器，一次全安装

- [winmerge]()

- [Matlab]() [🔗](http://bbs.06climate.com/forum.php?mod=viewthread&tid=30653)
